...
export default async function Page() {
  return (
    <>
      <ArticleHero subtitle="Updated at 2024-07-04" title="Privacy Policy" />
      <Container className="py-10">
        <TypographyLead>
          ...
          collected, used, and disclosed by {SITE_NAME}.
        </TypographyLead>
        ...
        <TypographyP>
          ...
          {SITE_NAME}. By accessing or using our Service, you signify that you
        ...
        <TypographyH2>Definitions and key terms</TypographyH2>
        <TypographyP>
        ...
        <TypographyList>
          ...
          <li>
            ...
            of
            {SITE_NAME} are based, in this case is United States
          </li>

          <li>
            <strong>Customer</strong>: refers to the company, organization or
            person that signs up to use the {SITE_NAME} Service to manage the
          ...
          <li>
            ...
            employed by {SITE_NAME} or are under contract to perform a service
        ...
        <TypographyH2>Information automatically collected</TypographyH2>
        <TypographyP>
          ...
          to call our Customer Services.
        </TypographyP>

        <TypographyP>
          We may also use browser data such as cookies, Flash cookies (also
          known as Flash Local Shared Objects) or similar data on certain parts
          of our Website for fraud prevention and other purposes. During your
        ...
        <TypographyH2>Sale of Business</TypographyH2>
        <TypographyP>
          ...
          of the assets of {SITE_NAME} or any of its Corporate Affiliates (as
          defined herein), or that portion of {SITE_NAME} or any of its
        ...
        <TypographyH2>Affiliates</TypographyH2>
        <TypographyP>
          ...
          {SITE_NAME}, whether by ownership or otherwise. Any information
        ...
        <TypographyP>
          ...
          international laws. By using {SITE_NAME} or contacting us directly,
        ...
        <TypographyH2>Kids' Privacy</TypographyH2>
        <TypographyP>
        ...
        <TypographyP>
          ...
          ("Third- Party Services"). You acknowledge and agree that {SITE_NAME}
          ...
          legality, decency, quality or any other aspect thereof. {SITE_NAME}{" "}
        ...
        <TypographyH2>Tracking Technologies</TypographyH2>

        <TypographyH3>Local Storage</TypographyH3>
        <TypographyP>
        ...
        <TypographyH3>Sessions</TypographyH3>
        <TypographyP>
          {SITE_NAME} uses "Sessions" to identify the areas of our website that
        ...
        <TypographyH3>What is GDPR?</TypographyH3>
        <TypographyP>
        ...
        <TypographyH3>What is personal data?</TypographyH3>
        <TypographyP>
        ...
        <TypographyH3>Why is GDPR important?</TypographyH3>
        <TypographyP>
          ...
          right thing to do. At {SITE_NAME} we strongly believe that your data
        ...
        <TypographyP>
          ...
          requirements of GDPR. {SITE_NAME} processes or stores all personal
        ...
        <TypographyH2>California Residents</TypographyH2>
        <TypographyP>
        ...
        <TypographyP>
          ...
          would like to exercise any of these rights, please contact us. We do
          not sell the Personal Information of our users. For more information
          about these rights, please contact us.
        </TypographyP>
